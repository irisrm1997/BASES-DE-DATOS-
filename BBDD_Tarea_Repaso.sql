...
estadounidenses (USD).*/
SELECT nombre, (precio/1.00) AS EURO, (precio/1.19) AS DOLLAR 
FROM producto
...
euros, dólares.*/
SELECT nombre AS nombre_de_producto, (precio/1.00) AS euros, (precio/1.19) AS dólares
FROM producto;
...
SELECT nombre, SUBSTR(NOMBRE,1,2) AS caracteres
FROM fabricante;
